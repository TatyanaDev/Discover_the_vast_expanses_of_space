        ...
        <nav className={`header__links ${menuOpen ? "header__links--open" : ""}`}>
          ...
          <a href="/cart" className="header__link">
            <div className="cart-icon">
              <svg width="24" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" className="cart-icon__default">
              ...
              <svg width="24" height="20" fill="none" xmlns="http://www.w3.org/2000/svg" className="cart-icon__gradient">
